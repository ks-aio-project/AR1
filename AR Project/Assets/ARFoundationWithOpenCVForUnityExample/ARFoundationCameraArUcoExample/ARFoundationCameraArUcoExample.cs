...
namespace ARFoundationWithOpenCVForUnityExample
{
    ...
    public class ARFoundationCameraArUcoExample : MonoBehaviour
    {
        ...
        {
            // KKS
            Debug.Log($"KKS : UpdateARObjectTransform");
            arGameObject.gameObject.SetActive(true);
            Debug.Log($"KKS Active :  {arGameObject.gameObject.activeSelf}");
            Debug.Log($"KKS POS : arobj : {arGameObject.transform.position}");
            Debug.Log($"KKS POS : cam : {Camera.main.transform.position}");
        ...
        {
            // KKS
            Debug.Log($"KKS : ResetObjectTransform");
            arGameObject.gameObject.SetActive(true);
